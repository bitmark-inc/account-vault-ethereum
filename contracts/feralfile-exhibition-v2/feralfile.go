...
func (c *FeralfileExhibitionV2Contract) Deploy(wallet *ethereum.Wallet, arguments json.RawMessage) (string, string, error) {
	...
	address, tx, _, err := DeployFeralfileExhibitionV2(t, wallet.RPCClient(),
		params.Name, params.Symbol, params.ExhibitionTitle,
		&params.MaxEdition.Int, &params.RoyaltyBPS.Int, params.RoyaltyPayoutAddress,
...
func (c *FeralfileExhibitionV2Contract) Call(wallet *ethereum.Wallet, method, fund string, arguments json.RawMessage, noSend bool) (*types.Transaction, error) {
